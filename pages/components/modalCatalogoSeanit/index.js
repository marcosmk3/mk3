...
const Catalogo = () => {
  return (
    ...
    <section>
      ...
      <a  data-toggle="modal" data-target=".bd-example-modal-xl2" ><Image src={Seanit} alt='Seanit'/></a>

      <div className="modal fade bd-example-modal-xl2" tabIndex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
